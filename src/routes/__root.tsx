...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Growve" },
      { property: "og:description", content: "A calm social habit tracker. Each completed habit plants a permanent tree in your forest." },
